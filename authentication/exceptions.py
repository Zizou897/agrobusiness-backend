...
class UsernameOrEmailAlreadyExistsError(APIException):
    status_code = 401
    default_detail = "Un utilisateur avec ce nom d'utilisateur ou cette adresse email existe déjà."
...
class UserRegistrationNotCompleteError(APIException):
    status_code = 401
    default_detail = "L'inscription n'est pas encore terminée, veuillez recommencer celle-ci ."

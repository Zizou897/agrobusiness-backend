    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profil_type', models.CharField(choices=[('ENTREPRISE', 'Entreprise'), ('USER', 'Utilisateur'), ('FARMER', 'Agriculteur'), ('MERCHANT', 'Commerçant')], default='USER', max_length=255, verbose_name='Profil type')),
